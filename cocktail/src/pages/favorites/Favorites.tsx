...
export const Favorites: React.FC = () => {
    ...
    return (
        <div className="w-screen h-screen overflow-x-hidden bg-bgCategory">
            <div
            ...
            >
                ...
                <h3 className="font-sans text-secondTextColor">
                    Looking to learn new drinks for receptions and celebratory
                    gatherings? Ceck out the largest free drink recipe book
                    below.
                </h3>
            </div>
