    ...
    if (favorites.length === 0) {
        return (
            <div className="w-screen h-screen overflow-x-hidden flex flex-wrap items-start bg-bgCategory">
                ...
                <div className="flex flex-col w-screen items-center justify-center mb-16">
                    <img src={emptyCocktailGlass} alt="empty-cocktail-glass" className="w-6/12 md:w-96 h-3/6 mt-40 lg:mt-10"/>
                    <h2 className="text-secondTextColor font-sans text-xl px-4 text-center">
                        Oops! Looks like your list of favorite drinks is dry.
        ...
        return (
            <div className="w-screen min-h-screen h-screen overflow-x-hidden bg-bgCategory">
                <Header />
                <div className="flex flex-col w-screen place-content-center h-60 md:h-96 px-5 md:pl-16 md:ml-4 gap-4
            leading-1">
                    <h1 className="text-principalTitleColor font-sans">
                        Favorites
                    </h1>
                    <h3 className="font-sans text-secondTextColor">
                        Looking to learn new drinks for receptions and
                        celebratory gatherings? Ceck out the largest free drink
                        recipe book below.
                    </h3>
                </div>
